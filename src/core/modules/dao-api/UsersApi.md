...
# **getUserInvitations**
> UserInvitationsResponse getUserInvitations()
...
const data = await apiInstance.getUserInvitations(request);
console.log('API called successfully. Returned data:', data);
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | User invitations retrieved successfully |  -  |
**404** | User not found |  -  |
**401** | Unauthorized - Invalid or missing token |  -  |
**0** | Default error response |  -  |
...
# **searchUsers**
> UserSearchResponse searchUsers()
...
```typescript
import { createConfiguration, UsersApi } from '';
import type { UsersApiSearchUsersRequest } from '';

const configuration = createConfiguration();
const apiInstance = new UsersApi(configuration);

const request: UsersApiSearchUsersRequest = {
    // Username to search for
  username: "username_example",
};

const data = await apiInstance.searchUsers(request);
console.log('API called successfully. Returned data:', data);
```
...
|-------------|-------------|------------------|
**422** | Unprocessable Entity |  -  |
**200** | Users matching search criteria |  -  |
**401** | Unauthorized |  -  |
**0** | Default error response |  -  |
